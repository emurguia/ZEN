...
Check() {
    ...
    # Run "$CC" "-o" "${basename}.exe" "${basename}.s"  "make_circle.o" "make_triangle.o" "make_line.o" "make_point.o" "make_rectangle.o" "make_window.o" "close_window.o" "keep_open.o"  "/usr/local/lib/libsigil.so" &&
